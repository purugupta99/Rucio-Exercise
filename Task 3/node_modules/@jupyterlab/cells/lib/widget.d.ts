...
import { JSONValue, JSONObject, PartialJSONValue } from '@lumino/coreutils';
 ...
 */
export declare abstract class AttachmentsCell extends Cell {
    /**
     ...
     */
    protected abstract updateCellSourceWithAttachment(attachmentName: string): void;
    /**
 ...
 */
export declare class MarkdownCell extends AttachmentsCell {
    /**
