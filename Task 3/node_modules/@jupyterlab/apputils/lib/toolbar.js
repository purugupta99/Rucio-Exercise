...
import { Button, circleEmptyIcon, circleIcon, classes, LabIcon, refreshIcon, stopIcon } from '@jupyterlab/ui-components';
...
export function ToolbarButtonComponent(props) {
    ...
    return (React.createElement(Button, { className: props.className
        ...
        React.createElement(LabIcon.resolveReact, { icon: props.icon, iconClass: 
