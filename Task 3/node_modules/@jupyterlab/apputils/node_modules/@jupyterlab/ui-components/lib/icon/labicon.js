...
export class LabIcon {
    ...
    element(props = {}) {
        var _a, _b, _c;
        let _d = Object.assign(Object.assign({}, this._props), props), { className, container, label, title, tag = 'div' } = _d, styleProps = __rest(_d, ["className", "container", "label", "title", "tag"]);
        // check if icon element is already set
        const maybeSvgElement = (_a = container) === null || _a === void 0 ? void 0 : _a.firstChild;
        if (((_c = (_b = maybeSvgElement) === null || _b === void 0 ? void 0 : _b.dataset) === null || _c === void 0 ? void 0 : _c.iconId) === this._uuid) {
    ...
    render(container, options) {
        var _a, _b, _c;
        let label = (_b = (_a = options) === null || _a === void 0 ? void 0 : _a.children) === null || _b === void 0 ? void 0 : _b[0];
        // narrow type of label
        if (typeof label !== 'string') {
            label = undefined;
        }
        this.element(Object.assign({ container,
            label }, (_c = options) === null || _c === void 0 ? void 0 : _c.props));
    }
    get svgstr() {
        return this._svgstr;
    }
    ...
    _initReact(displayName) {
        const component = React.forwardRef((props = {}, ref) => {
            let _a = Object.assign(Object.assign({}, this._props), props), { className, container, label, title, tag = 'div' } = _a, styleProps = __rest(_a, ["className", "container", "label", "title", "tag"]);
            ...
            const svgComponent = (React.createElement("svg", Object.assign({}, getReactAttrs(svgElement), { dangerouslySetInnerHTML: { __html: svgElement.innerHTML }, ref: ref })));
            if (container) {
                Private.initContainer({ container, className, styleProps, title });
                return (React.createElement(React.Fragment, null,
                    svgComponent,
...
(function (Private) {
    ...
    class ElementRenderer extends Renderer {
        render(container, options) {
            ...
            this._icon.element(Object.assign(Object.assign({ container,
                label }, (_c = this._rendererOptions) === null || _c === void 0 ? void 0 : _c.props), (_d = options) === null || _d === void 0 ? void 0 : _d.props));
        }
    }
    ...
    class ReactRenderer extends Renderer {
        render(container, options) {
            ...
            return ReactDOM.render(React.createElement(this._icon.react, Object.assign({ container: container, label: label }, Object.assign(Object.assign({}, (_c = this._rendererOptions) === null || _c === void 0 ? void 0 : _c.props), (_d = options) === null || _d === void 0 ? void 0 : _d.props))), container);
        }
        unrender(container) {
